...
Class  EE_Promotions extends EE_Addon {
	...
	public static function register_addon() {
		...
		add_filter( 'FHEE__EE_Shortcodes__parser_after', array( 'EE_Promotions', 'register_new_shortcode_parsers'), 10, 5 );
	}
	...
	public static function register_new_shortcodes( $shortcodes, EE_Shortcodes $lib ) {
		...
		if ( $lib instanceof EE_Transaction_Shortcodes ) {
			//Add shortcode to the add as the key, the value should be a description of the shortcode.
	...
	public static function register_new_shortcode_parsers( $parsed, $shortcode, $data, $extra_data, EE_Shortcodes $lib ) {
		//only do this parsing on the EE_Transaction_Shortcodes parser
